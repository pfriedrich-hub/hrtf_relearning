...
kemar_free = slab.HRTF(path / '1.4' / 'kemar_ears_free_1.4_18.10.sofa')
kemar_speakers = slab.HRTF(path / '1.4' / 'side_speakers_1.4_18.10.sofa')
...
hrtf_plot.hrtf_image(kemar_free, bandwidth=(2000, 16000), z_min=-30, z_max=30, cbar=False, axis=axes[0], chan=chan)
axes[0].set_title('no side speakers')
hrtf_plot.hrtf_image(kemar_speakers, bandwidth=(2000, 16000), z_min=-30, z_max=30, cbar=False, axis=axes[1], chan=chan)
axes[1].set_title('with side speakers')
hrtf_plot.hrtf_image(kemar_difference, bandwidth=(2000, 16000), z_min=-30, z_max=30, cbar=True, axis=axes[2], chan=chan)
