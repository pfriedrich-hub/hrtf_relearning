...
class Subject:
    ...
    def _write_backup(self):
        ...
        Nothing in this module reads the backup back. It is also read by
        game_ui.read_scoreboard() (id + highscore only) to render the
        cross-participant scoreboard during training without needing to
