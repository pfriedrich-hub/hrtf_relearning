...
def plot_time_course(figsize=(14, 7)):
    ...
    x2 = [15]
    axes[0].set_xticks(x1, labels=x1, size=8)
    axes[0].set_xlim(-.5, 10.5)
    axes[1].set_xticks(x2, labels=x2, size=8)
    ...
    textstr_day0 = '\n'.join((r'$\bullet\,$' + 'Free ears\n   localization test',
                              r'$\bullet\,$' + 'Mold 1 insertion\n   & localization test',))

    textstr_day5 = '\n'.join((r'$\bullet\,$' + 'Mold 1 localization\n   test & removal',
                              r'$\bullet\,$' + 'Free ears\n   localization test',
                              r'$\bullet\,$' + 'Mold 2 insertion \n   & localization test'))

    textstr_day10 = '\n'.join((r'$\bullet\,$' + 'Mold 2 localization\n   test & removal',
                               r'$\bullet\,$' + 'Mold 1 re-insertion \n   & localization test',
                               r'$\bullet\,$' + 'Free Ears\n   localization test'))

    textstr_day15 = 'Mold 2 re-insertion\n& localization test'
    ...
    axes[0].annotate('Daily training and\nlocalization tests\nwith mold 1', xy=(2.5, 0.13), xytext=(2.5, textbox2_h),
    ...
    axes[0].annotate('Daily training and\nlocalization tests \nwith mold 2', xy=(7.5, 0.13), xytext=(7.5, textbox2_h),
                     xycoords=axes[0].get_xaxis_transform(), fontsize=fs, ha='center', va='bottom',
                    bbox=bbox_props, arrowprops=dict(arrowstyle='-[, widthB=6, lengthB=1', lw=lw, color='k'))
    ...
    axes[1].annotate(textstr_day15, xy=(15, 0.05), xytext=(14, textbox2_h),
