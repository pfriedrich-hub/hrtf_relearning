...
m1m2_m2ef_p = scipy.stats.wilcoxon(vsi_dis_efm2, vsi_dis_m1m2, alternative='greater', nan_policy='omit')
"dissimilarity between participants’ free ears and the first mold was comparable to the dissimilarity between the first and the second mold"
efm1_m1m2_p = scipy.stats.wilcoxon(vsi_dis_efm1, vsi_dis_m1m2, alternative='greater', nan_policy='omit')
"The second earmold induced larger changes to participants’ native ears than the first set "
efm1_efm2_p = scipy.stats.wilcoxon(vsi_dis_efm1, vsi_dis_efm2, alternative='less', nan_policy='omit')
