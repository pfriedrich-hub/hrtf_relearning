...
def get_localization_dictionary(path=Path.cwd() / 'legacy' / 'MSc' / 'data' / 'experiment' / 'master',
...
def get_localization_data(localization_dictionary, subjects, w2_exclude):
    ...
    for condition in localization_dictionary.keys():
        ...
        localization_dictionary[condition]['data'] = numpy.zeros((len(subjects), 7, 6))
        localization_dictionary[condition]['SE'] = numpy.zeros((7, 6))  # SE for each measure days x eg/ele_rmse/sd/ele_az_rmse/az_sd
