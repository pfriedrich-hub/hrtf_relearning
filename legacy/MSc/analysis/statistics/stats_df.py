...
def add_hrtf_stats(main_df, bandwidth, vsi_dis_bw=None):  # , bands=None):
    ...
    for subject_id, row in main_df.iterrows():
        ...
        row['EF VSI'] = hrtf_analysis.vsi(hrtf_ef, bandwidth, ear_idx=[0, 1], average=True)
        row['EF spectral strength'] = hrtf_analysis.spectral_strength(hrtf_ef, bandwidth)

        row['EF VSI l'] = hrtf_analysis.vsi(hrtf_ef, bandwidth, ear_idx=[0])
        row['EF VSI r'] = hrtf_analysis.vsi(hrtf_ef, bandwidth, ear_idx=[1])
        row['EF spectral strength r'] = hrtf_analysis.spectral_strength(hrtf_ef, bandwidth,
                                                                                            ear='right')
        row['EF spectral strength l'] = hrtf_analysis.spectral_strength(hrtf_ef, bandwidth,
                                                                                            ear='left')
        if hrtf_m1:
            row['EF M1 VSI dissimilarity'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m1, vsi_dis_bw)
            row['EF M1 spectral difference'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m1, vsi_dis_bw)
            # row['EF M1 weighted VSI dissimilarity'] = \
            #     hrtf.weighted_vsi_dissimilarity(hrtf_ef, hrtf_m1, bands)
            row['M1 VSI'] = hrtf_analysis.vsi(hrtf_m1, bandwidth, ear_idx=[0, 1], average=True)
            row['M1 spectral strength'] = hrtf_analysis.spectral_strength(hrtf_m1, bandwidth)

            row['M1 VSI l'] = hrtf_analysis.vsi(hrtf_m1, bandwidth, ear_idx=[0])
            row['M1 VSI r'] = hrtf_analysis.vsi(hrtf_m1, bandwidth, ear_idx=[1])
            row['M1 spectral strength r'] = hrtf_analysis.spectral_strength(hrtf_m1, bandwidth, ear='right')
            row['M1 spectral strength l'] = hrtf_analysis.spectral_strength(hrtf_m1, bandwidth, ear='left')
            row['EF M1 VSI dissimilarity l'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m1,
                                                                                                   vsi_dis_bw,
                                                                                                   ear_idx=[0])
            row['EF M1 VSI dissimilarity r'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m1,
                                                                                                   vsi_dis_bw,
                                                                                                   ear_idx=[1])
            row['EF M1 spectral difference l'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m1,
                                                                                                       vsi_dis_bw,
                                                                                                       ear='left')
            row['EF M1 spectral difference r'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m1,
                                                                                                       vsi_dis_bw,
                                                                                                       ear='right')

        if hrtf_m2:

            row['M2 VSI'] = hrtf_analysis.vsi(hrtf_m2, bandwidth, ear_idx=[0, 1], average=True)
            row['M2 spectral strength'] = hrtf_analysis.spectral_strength(hrtf_m2, bandwidth)
            row['M2 VSI l'] = hrtf_analysis.vsi(hrtf_m2, bandwidth, ear_idx=[0])
            row['M2 VSI r'] = hrtf_analysis.vsi(hrtf_m2, bandwidth, ear_idx=[1])
            row['M2 spectral strength r'] = hrtf_analysis.spectral_strength(hrtf_m2, bandwidth,
                                                                                                ear='right')
            row['M2 spectral strength l'] = hrtf_analysis.spectral_strength(hrtf_m2, bandwidth,
                                                                                                ear='left')

            row['EF M2 VSI dissimilarity'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m2, vsi_dis_bw)
            row['EF M2 spectral difference'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m2, vsi_dis_bw)
            # row['EF M2 weighted VSI dissimilarity'] = \
            #     hrtf.weighted_vsi_dissimilarity(hrtf_ef, hrtf_m2, bands)
            row['EF M2 VSI dissimilarity l'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m2,
                                                                                                   vsi_dis_bw,
                                                                                                   ear_idx=[0])
            row['EF M2 VSI dissimilarity r'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m2,
                                                                                                   vsi_dis_bw,
                                                                                                   ear_idx=[1])
            row['EF M2 spectral difference l'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m2,
                                                                                                       vsi_dis_bw,
                                                                                                       ear='left')
            row['EF M2 spectral difference r'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m2,
                                                                                                       vsi_dis_bw,
                                                                                                       ear='right')

        if (hrtf_m2 and hrtf_m1):
            row['M1 M2 VSI dissimilarity'] = hrtf_analysis.vsi_dissimilarity(hrtf_m1, hrtf_m2, vsi_dis_bw)
            row['M1 M2 spectral difference'] = hrtf_analysis.spectral_difference(hrtf_m1, hrtf_m2, vsi_dis_bw)
            # row['M1 M2 weighted VSI dissimilarity'] = \
            #     hrtf.weighted_vsi_dissimilarity(hrtf_m1, hrtf_m2, bands)

            row['M1 M2 VSI dissimilarity l'] = hrtf_analysis.vsi_dissimilarity(hrtf_m1, hrtf_m2,
                                                                                                   vsi_dis_bw, ear_idx=[0])
            row['M1 M2 VSI dissimilarity r'] = hrtf_analysis.vsi_dissimilarity(hrtf_m1, hrtf_m2,
                                                                                                   vsi_dis_bw, ear_idx=[1])
            row['M1 M2 spectral difference l'] = hrtf_analysis.spectral_difference(hrtf_m1, hrtf_m2,
                                                                                                       vsi_dis_bw,
                                                                                                       ear='left')
            row['M1 M2 spectral difference r'] = hrtf_analysis.spectral_difference(hrtf_m1, hrtf_m2,
                                                                                                       vsi_dis_bw,
                                                                                                       ear='right')
        main_df.loc[subject_id] = row
...
def spectral_change_p(main_df, threshold=None, bandwidth=(4000,16000), return_n=True):
    ...
    if return_n: # return absolute numbers
        efm1_p = numpy.mean(numpy.sum(numpy.array(spectral_changes_efm1), axis=0), axis=2)
        efm2_p = numpy.mean(numpy.sum(spectral_changes_efm2, axis=0), axis=2)
        m1m2_p = numpy.mean(numpy.sum(spectral_changes_m1m2, axis=0), axis=2)
    ...
    if return_n:
        n = [m1_sub, m2_sub]  # return sample size
        if not threshold:
            return numpy.array((efm1_p, efm2_p, m1m2_p)), thresholds, n
        else:
            return numpy.array((efm1_p, efm2_p, m1m2_p)), None, n
...
def add_l_r_comparison(main_df, bandwidth):
    ...
    for subject_id, row in main_df.iterrows():
        ...
        row['EF VSI l'] = hrtf_analysis.vsi(hrtf_ef, bandwidth, ear_idx=[0])
        row['EF VSI r'] = hrtf_analysis.vsi(hrtf_ef, bandwidth, ear_idx=[1])
        row['EF spectral strength r'] = hrtf_analysis.spectral_strength(hrtf_ef, bandwidth, ear='right')
        row['EF spectral strength l'] = hrtf_analysis.spectral_strength(hrtf_ef, bandwidth, ear='left')
        if hrtf_m1:
            row['M1 VSI l'] = hrtf_analysis.vsi(hrtf_m1, bandwidth, ear_idx=[0])
            row['M1 VSI r'] = hrtf_analysis.vsi(hrtf_m1, bandwidth, ear_idx=[1])
            row['M1 spectral strength r'] = hrtf_analysis.spectral_strength(hrtf_m1, bandwidth, ear='right')
        ...
        if hrtf_m2:
            row['M2 VSI l'] = hrtf_analysis.vsi(hrtf_m2, bandwidth, ear_idx=[0])
            row['M2 VSI r'] = hrtf_analysis.vsi(hrtf_m2, bandwidth, ear_idx=[1])
            row['M2 spectral strength r'] = hrtf_analysis.spectral_strength(hrtf_m2, bandwidth, ear='right')
            row['M2 spectral strength l'] = hrtf_analysis.spectral_strength(hrtf_m2, bandwidth, ear='left')
        # vsi dissimilarity / spectral difference left right m1 m2
        if hrtf_m1:
            row['EF M1 VSI dissimilarity l'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m1, bandwidth, ear_idx=[0])
            row['EF M1 VSI dissimilarity r'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m1, bandwidth, ear_idx=[1])
            row['EF M1 spectral difference l'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m1, bandwidth, ear='left')
            row['EF M1 spectral difference r'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m1, bandwidth, ear='right')
        if hrtf_m2:
            row['EF M2 VSI dissimilarity l'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m2, bandwidth, ear_idx=[0])
            row['EF M2 VSI dissimilarity r'] = hrtf_analysis.vsi_dissimilarity(hrtf_ef, hrtf_m2, bandwidth, ear_idx=[1])
            row['EF M2 spectral difference l'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m2, bandwidth, ear='left')
            row['EF M2 spectral difference r'] = hrtf_analysis.spectral_difference(hrtf_ef, hrtf_m2, bandwidth, ear='right')
        if (hrtf_m1 and hrtf_m2):
            row['M1 M2 VSI dissimilarity l'] = hrtf_analysis.vsi_dissimilarity(hrtf_m1, hrtf_m2, bandwidth, ear_idx=[0])
            row['M1 M2 VSI dissimilarity r'] = hrtf_analysis.vsi_dissimilarity(hrtf_m1, hrtf_m2, bandwidth, ear_idx=[1])
            row['M1 M2 spectral difference l'] = hrtf_analysis.spectral_difference(hrtf_m1, hrtf_m2, bandwidth, ear='left')
            row['M1 M2 spectral difference r'] = hrtf_analysis.spectral_difference(hrtf_m1, hrtf_m2, bandwidth, ear='right')
        main_df.loc[subject_id] = row
    main_df = main_df.replace(r'^\s*$', None, regex=True)
    return main_df