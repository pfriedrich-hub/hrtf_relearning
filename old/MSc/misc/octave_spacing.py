...
def overlapping_bands():
    bands = []
    # --- 5 overlapping octave bands
    bands.append([(4000, 8000), (4800, 9500), (5700, 11300), (6700, 13500), (8000, 16000)])
    ...
    # 2**3 = 8; -> 3 is the logarithm of 8 to base 2, or 3 = log2 8

    bands.append([(3500, 7000), (4200, 8500), (5100, 10200), (6200, 12400), (7500, 15000)])
...
# single band dev: 3.7 to 12.9 kHz (middlebrooks 1999)