...
participant's own headphone equalization filter. Impulse responses derived
from directional transfer functions carry no absolute scale, so each database
was scaled by a single broadband factor to a common chain gain; presentation
