...
and listeners, so a setting chosen against one directional transfer function
...
variation of the directional transfer function at the same spectral scales. At
